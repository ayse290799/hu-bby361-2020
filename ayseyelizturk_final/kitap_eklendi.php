<?php
    ...
    /* Ekleme İşlemi Sorgusu */
    $KitapKayitNo= mysqli_real_escape_string($baglanti, $_POST['KitapKayitNo']);
    $KitapKayitTarih = mysqli_real_escape_string($baglanti, $_POST['KitapKayitTarih']);
    ...
    $KitapSayfaSayi = mysqli_real_escape_string($baglanti, $_POST['KitapSayfaSayi']);
    ...
    $KitapKopyaSayi = mysqli_real_escape_string($baglanti, $_POST['KitapKopyaSayi']);
    $YayinEviKayitNo = mysqli_real_escape_string($baglanti, $_POST['YayinEviKayitNo']);
    $sorgu = "INSERT INTO kitap (KitapKayitNo, KitapKayitTarih, KitapISBN, KitapAdi, YazarKayitNo, KitapSayfaSayi, KitapBasimYeri,        KitapBasimTarih, KitapKopyaSayi, YayinEviKayitNo)
            VALUES ('$KitapKayitNo', '$KitapKayitTarih', '$KitapISBN',  '$KitapAdi', '$YazarKayitNo', '$KitapSayfaSayi', '$KitapBasimYeri',  '$KitapBasimTarih', '$KitapKopyaSayi', '$YayinEviKayitNo')";
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM kitap ORDER BY KitapKayitNo DESC");
...
<!-- KODLAR -->
<h1>Kitap İşlemSonucu</h1>
<p><?php echo $islemSonuc; ?></p>
<p><a href="kitap_ekle.php">Yeni Kitap Ekle</a></p>
<?php
echo("<table border=1 width=80%>");
    echo("<tr>");
    echo("<td><b>KitapKayitNo</b></td>");
    echo("<td><b>KitapKayitTarih</b></td>");
    echo("<td><b>KitapISBN</b></td>");
    echo("<td><b>KitapAdi</b></td>");
    echo("<td><b>YazarKayitNo</b></td>");
    echo("<td><b>KitapSayfaSayi</b></td>");
    echo("<td><b>KitapBasımYeri</b></td>");
    echo("<td><b>KitapBasimTarih</b></td>");
    echo("<td><b>KitapKopyaSayi</b></td>");
    echo("<td><b>YayinEviKayıtNo</b></td>");
