<?php
    ...
    $sorgu = "INSERT INTO yazar (YazarKayitNo, YazarAdi, YazarSoyadi, YazarUrl)
            VALUES ('$YazarKayitNo', '$YazarAdi', '$YazarSoyadi', '$YazarUrl' )";
...
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>YazarAdi</b></td>");
    echo("<td><b>YazarSoyadi</b></td>");
