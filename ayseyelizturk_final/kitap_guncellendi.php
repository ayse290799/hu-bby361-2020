<?php
    ...
    $sorgu = "UPDATE kitap SET KitapKayitTarih = '$KitapKayitTarih', KitapISBN= '$KitapISBN', KitapAdi= '$KitapAdi', YazarKayitNo = '$YazarKayitNo', KitapSayfaSayi= '$KitapSayfaSayi', KitapBasimYeri = '$KitapBasimYeri', KitapBasimTarih = '$KitapBasimTarih', KitapKopyaSayi='$KitapKopyaSayi', YayinEviKayitNo='$YayinEviKayitNo' WHERE KitapKayitNo = '$KitapKayitNo' ";
...
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>KitapBasimYeri</b></td>");
    echo("<td><b>KitapBasimTarih</b></td>");
    echo("<td><b>KitapKopyaSayi</b></td>");
    echo("<td><b>YayinEviKayitNo</b></td>");
